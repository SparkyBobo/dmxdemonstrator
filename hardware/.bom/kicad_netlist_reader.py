...
class netlist():
    ...
    def addElement(self, name):
        ...
        # Assign the title_block element
    ...
    def getTitle(self):
        """Return the title string from the title block which was used to create the netlist tree"""
        return self.titleBlock.get("title")        

    def getCompany(self):
        """Return the company string from the title block which was used to create the netlist tree"""
        return self.titleBlock.get("company")        

    def getRev(self):
        """Return the rev string from the title block which was used to create the netlist tree"""
        return self.titleBlock.get("rev")        

    def getShortSource(self):
        """Return the source string from the title block which was used to create the netlist tree"""
        return self.titleBlock.get("source")        
